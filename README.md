...
- Ruby
    - Windows (recommended): [https://rubyinstaller.org](https://rubyinstaller.org/){:target="_blank"} (this includes RubyGems and Bundler)
    - Other: [https://www.ruby-lang.org/en/documentation/installation](https://www.ruby-lang.org/en/documentation/installation){:target="_blank"}
- RubyGems: [https://rubygems.org/pages/download](https://rubygems.org/pages/download){:target="_blank"}
- Bundler: [https://bundler.io/#getting-started](https://bundler.io/#getting-started){:target="_blank"}
...
### Running the project
The project is served using [Jekyll](https://jekyllrb.com/){:target="_blank"}, this processes all of the files in the project and turns it into proper HTML before deploying it.
